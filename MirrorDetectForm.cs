...
namespace TestTool
{
    public partial class MirrorDetectForm : Form
    {
        ...
        private void MirrorDetectForm_Load(object sender, EventArgs e)
        {
            txtUrl.Text = ApiEndpoints.GetUrl("mirror detect");
        }
        ...
        private class MirrorDetectRequest
        {
