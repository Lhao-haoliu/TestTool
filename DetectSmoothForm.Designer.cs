namespace TestTool
{
    partial class DetectSmoothForm
    {
        ...
        {
            // ✅ txtUrl 改成 ComboBox（名称不变：txtUrl）
            ...
            this.Name = "DetectSmoothForm";
            this.Text = "Detect Smooth API Tester";
            this.Load += new System.EventHandler(this.DetectSmoothForm_Load);
            ((System.ComponentModel.ISupportInitialize)(this.pictureBoxImage)).EndInit();
            this.ResumeLayout(false);
            this.PerformLayout();
        }

        // ✅ 字段声明改为 ComboBox（名字仍 txtUrl）
