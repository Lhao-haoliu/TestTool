...
namespace TestTool
{
    public partial class OcrVlForm : Form
    {
        ...
        private void OcrVlForm_Load(object sender, EventArgs e)
        {
            txtUrl.Text = "http://10.53.192.100:3885/ocr_vl";
        }
